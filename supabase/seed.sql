...
begin
  ...
  insert into public.orders (
    customer_id, contact_name, contact_email, contact_phone,
    fulfillment, time_window, ship_street, ship_city, ship_state, ship_zip,
    subtotal_cents, total_cents,
    status, payment_status, placed_at
  ) values (
    null, 'Walk-in Guest', 'guest@example.com', '816-555-0199',
    'delivery', 'afternoon', '123 Main St', 'Kansas City', 'MO', '64111',
    1000, 1000,
