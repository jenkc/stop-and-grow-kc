...
function NativeSelect({
  ...
  return (
    <div
      className={cn(
        // w-full to match Input — the two sit side by side in the order form.
        // cn() merges, so a caller that genuinely wants content-width can pass
        // className="w-fit".
